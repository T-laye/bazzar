...
const HeroSlider: React.FC = () => {
  const slides: Slide[] = [
    ...
    },
    {
      ...
      image: "/material_testing.webp", // Replace with your actual image path
  ...
  return (
    <div className="relative w-full h-[600px] md:h-[700px] overflow-hidden">
      ...
      <button 
        onClick={nextSlide} 
        className="absolute top-1/2 right-4 -translate-y-1/2 bg-primary rounded-full p-2 z-20 hover:bg-white/50 transition"
      >
