              ...
              <div className="mb-4 md:mb-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`flex flex-col items-center ${currentStep >= 2 ? 'text-red-800' : 'text-gray-400'}`}>
                    <div className={`w-6 h-6 md:w-8 md:h-8 rounded-full flex items-center justify-center border-2 ${currentStep >= 2 ? 'border-red-800 bg-red-100' : 'border-gray-300'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      <div className="col-span-2">
                        ...
                        <input 
                          ...
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.fullName ? 'border-red-500' : 'border-gray-300'}`}
                      ...
                      <div className="col-span-2">
                        ...
                        <input 
                          ...
                          onChange={handleShippingChange}
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.address ? 'border-red-500' : 'border-gray-300'}`}
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          onChange={handleShippingChange}
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.city ? 'border-red-500' : 'border-gray-300'}`}
                          placeholder="Lagos"
                        />
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          onChange={handleShippingChange}
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.state ? 'border-red-500' : 'border-gray-300'}`}
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          onChange={handleShippingChange}
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.zipCode ? 'border-red-500' : 'border-gray-300'}`}
                          placeholder="100001"
                        />
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          onChange={handleShippingChange}
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.phone ? 'border-red-500' : 'border-gray-300'}`}
                    ...
                    <div className="space-y-3 md:space-y-4">
                      <div>
                        ...
                        <input 
                          ...
                          maxLength={19}
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.cardNumber ? 'border-red-500' : 'border-gray-300'}`}
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.cardHolder ? 'border-red-500' : 'border-gray-300'}`}
                          placeholder="John Doe"
                        />
                      ...
                      <div className="grid grid-cols-2 gap-3 md:gap-4">
                        <div>
                          ...
                          <input 
                            ...
                            onChange={handlePaymentChange}
                            className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.expiryDate ? 'border-red-500' : 'border-gray-300'}`}
                            placeholder="MM/YY"
                            maxLength={5}
                          />
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            onChange={handlePaymentChange}
                            className={`w-full p-2 border rounded-md text-sm md:text-base ${errors.cvv ? 'border-red-500' : 'border-gray-300'}`}
                            placeholder="123"
                            maxLength={4}
                          />
                  ...
                  <div>
                    ...
                    <div className="mb-3 md:mb-4 p-2 md:p-3 bg-gray-50 rounded-lg">
                      <div className="flex justify-between items-center mb-1 md:mb-2">
                        <h4 className="font-medium text-sm md:text-base">Shipping Address</h4>
                        <button 
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center p-2 md:p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                          ...
                          <div className="flex-1">
                            <span className="font-medium text-xs md:text-sm">Standard Delivery</span>
                            <p className="text-xs text-gray-600">3-5 business days</p>
                          </div>
                          <span className="font-medium text-xs md:text-sm">₦ 1,500</span>
                        </label>
                        ...
                        <label className="flex items-center p-2 md:p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                          ...
                          />
                          <div className="flex-1">
                            <span className="font-medium text-xs md:text-sm">Express Delivery</span>
                            <p className="text-xs text-gray-600">1-2 business days</p>
                          </div>
                          <span className="font-medium text-xs md:text-sm">₦ 3,000</span>
                        </label>
                        ...
                        <label className="flex items-center p-2 md:p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                          ...
                          />
                          <div className="flex-1">
                            <span className="font-medium text-xs md:text-sm">Next Day Delivery</span>
                            <p className="text-xs text-gray-600">Next business day</p>
                          </div>
                          <span className="font-medium text-xs md:text-sm">₦ 5,000</span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="border-t pt-3 md:pt-4">
                      ...
                      <div className="border-t pt-2 space-y-1">
                        <div className="flex justify-between">
                          ...
                          <span className="text-xs md:text-sm font-medium">₦ {subtotal.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-xs md:text-sm text-gray-600">Shipping</span>
                          <span className="text-xs md:text-sm font-medium">₦ {shippingCost.toLocaleString()}</span>
                        </div>
              ...
              <div className="flex justify-between">
                {currentStep > 1 ? (
                  <button 
                    ...
                    className="px-3 md:px-4 py-2 text-sm md:text-base border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
