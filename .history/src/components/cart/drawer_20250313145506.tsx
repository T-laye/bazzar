...
const CartDrawer = () => {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 1, name: "Power Engine Drill", price: 300000, quantity: 1, image: "/calibration.jpg" },
    { id: 2, name: "Calibration Tool Kit", price: 150000, quantity: 2, image: "/calibration.jpg" }
  ]);

  const cart = cartService.fetchCartItems().then((items) => {
    console.log(items)
  })
  console.log(cart)
