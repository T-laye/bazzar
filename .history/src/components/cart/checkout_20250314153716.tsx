  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-60 z-50 transition-opacity flex items-center justify-center">
        ...
        <div 
          ref={modalRef}
          className="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg shadow-xl m-4"
        >
          {/* Header */}
          <div className="p-4 border-b flex justify-between items-center bg-red-800 text-white rounded-t-lg">
          ...
          {orderComplete ? (
            ...
            <div className="p-8 text-center">
              ...
              <button 
                onClick={()=>onClose(false)}
                className="px-6 py-3 bg-red-800 text-white rounded-md hover:bg-red-700 transition-colors font-medium"
              >
                Continue Shopping
              </button>
            </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between">
                  <div className={`flex flex-col items-center ${currentStep >= 1 ? 'text-red-800' : 'text-gray-400'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${currentStep >= 1 ? 'border-red-800 bg-red-100' : 'border-gray-300'}`}>
                      <MapPin size={16} />
                    </div>
                  ...
                  <div className={`flex flex-col items-center ${currentStep >= 2 ? 'text-red-800' : 'text-gray-400'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${currentStep >= 2 ? 'border-red-800 bg-red-100' : 'border-gray-300'}`}>
                      <CreditCard size={16} />
                    </div>
                  ...
                  <div className={`flex flex-col items-center ${currentStep >= 3 ? 'text-red-800' : 'text-gray-400'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${currentStep >= 3 ? 'border-red-800 bg-red-100' : 'border-gray-300'}`}>
                      <Truck size={16} />
                    </div>
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="border-t pt-2 space-y-1">
                        ...
                        <div className="flex justify-between pt-2 border-t">
                          ...
                          <span className="font-bold text-red-800">₦ {totalPrice.toLocaleString()}</span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="flex justify-between">
                ...
                {currentStep < 3 ? (
                  <button 
                    ...
                    className="px-6 py-2 bg-red-800 text-white rounded-md hover:bg-red-700 transition-colors font-medium"
                  >
                    Continue
                  </button>
                ) : (
                  <button 
                    ...
                    className="px-6 py-2 bg-red-800 text-white rounded-md hover:bg-red-700 transition-colors font-medium flex items-center"
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? (
                      <>
