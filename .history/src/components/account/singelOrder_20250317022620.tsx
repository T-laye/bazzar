    ...
    <div className="container mx-auto max-w-2xl p-6">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-2 px-1">
          <p><span className="font-medium">Order Number:</span> {order?.trackingId}</p>
          <p><span className="font-medium">Order Date:</span> {order.orderDate}</p>
          <p><span className="font-medium">Tracking ID:</span> {orderData.trackingId}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <div className="space-y-2 px-1">
            <p><span className="font-medium">Name:</span> {orderData.delivery.name}</p>
            <p><span className="font-medium">Phone Number:</span> {orderData.delivery.phone}</p>
            <p><span className="font-medium">Email:</span> {orderData.delivery.email}</p>
        ...
        <div>
          ...
          <div className="space-y-2 px-1">
            ...
            <p className="pl-4"><span className="font-medium">Sub-Total:</span> ₦{orderData.payment.subtotal.toLocaleString()}</p>
            <p className="pl-4"><span className="font-medium">Delivery Fee:</span> {orderData.payment.deliveryFee}</p>
            <p className="font-medium">Total: ₦{orderData.payment.total.toLocaleString()}</p>
          </div>
        </div>
      </div>
    </div>
