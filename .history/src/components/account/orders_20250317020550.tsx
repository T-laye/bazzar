        ...
        <div className="space-y-4">
          {paginatedOrders.length > 0 ? (
            paginatedOrders.map((order) => (
              <div key={order.id} className="flex items-center border rounded-md shadow-sm">
                ...
                <div className="flex-grow p-4">
                  <h3 className="font-medium">{order.title || "Order #" + order.id}</h3>
                  <p className="text-sm text-gray-600">{order.customer || order.crew || "Customer"}</p>
