...
import OrderDetails from "@/components/account/singelOrder"
      ...
      <main className="max-w-6xl mx-auto p-4">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-64">
            ...
            <Button type='button' style='primary' css="w-full bg-red-600 text-white py-2 px-4 rounded mb-4 hover:bg-red-700">
              Log Out
            </Button>
          </div>
