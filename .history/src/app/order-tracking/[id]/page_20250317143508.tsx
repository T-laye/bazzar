            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <div className="bg-gray-100 p-3 rounded">
                  <p className="text-gray-700">{order?.parcelDate ? order.parcelDate.toLocaleDateString() : 'Not yet shippted'}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-100 p-3 rounded">
                  <p className="text-gray-700">{order?.expectedDeliveryDate ? order.expectedDeliveryDate?.toLocaleDateString() : 'Not yet delivered'}</p>
                </div>
              </div>
            </div>
