        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <>
                  ...
                  {data.product_media.length > 1 && (
                    <div className="grid grid-cols-4 gap-2">
                      {data.product_media.slice(0, 4).map((media, index) => (
                        <div 
                          key={index} 
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2">Product id: {data?.productId || "p9450202"}</p>
              ...
              <div className="mt-4 text-sm text-gray-700">
                <p>{data?.description || "Quisque varius diam vel metus mattis, id aliquam diam rhoncus. Proin vitae magna in dui finibus malesuada et at nulla. Morbi elit ex, viverra vitae ante vel, blandit feugiat ligula."}</p>
              </div>
              
              <div className="mt-6">
                <p className="text-3xl font-bold text-red-700">₦ {data?.price?.toLocaleString() || "300,000"}</p>
              </div>
