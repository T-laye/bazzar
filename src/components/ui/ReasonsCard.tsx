...
interface ReasonsReadMore {
  title?: string;
  text?: string;
  image?: string;
}

const ReasonsCard: FC<ReasonsReadMore> = ({ title, text, image }) => {
  const [expanded, setExpanded] = useState(false);
  
  // Default text if none provided
  const displayText = text || "Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, asperiores!";
